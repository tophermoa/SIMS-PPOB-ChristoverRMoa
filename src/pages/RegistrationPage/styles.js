export const styles = {
  ...
  leftSide: "w-full lg:w-1/2 flex items-center justify-center px-6 py-12",
  ...
  loginText: "text-center text-sm text-gray-500 mt-6",
  loginLink: "text-red-500 font-semibold hover:underline",
